  ...
  <PageWrapLayout>
    ...
    <el-descriptions title="配置项 " :column="1" border class="descriptions">
      <el-descriptions-item label="官方文档">
        <a href="https://github.com/crabbly/Print.js" target="_blank">https://github.com/crabbly/Print.js</a>
      ...
      <el-descriptions-item label="documentTitle">
        打印html，image或json时，它将显示为文档标题。如果用户尝试将打印作业保存为pdf文件，它也将是文档的名称。
      </el-descriptions-item>
      <el-descriptions-item label="scanStyles"
        >设置为false时，库不会处理应用于正在打印的html的样式。使用css参数时很有用
      </el-descriptions-item>
      <el-descriptions-item label="targetStyle">
      ...
      <el-descriptions-item label="honorColor">
        要以彩色打印文本，请将此属性设置为true。默认情况下，所有文本都将以黑色打印。
      </el-descriptions-item>
      <el-descriptions-item label="css">
